...
# phrase detector
phrase_detector = PmiPhraseDetector(RawSentenceStream(fz_docs=False), filename="PHRASE_")
...
for dim in dims:
    ...
    m = D2Vmodel(
        ...
        epochs=epochs,
        modelfile="DOC2VEC_CASEREPORT-PMI90_",
        dimension=dim)
    ...
    for case in CaseReportLibrary():
        ...
        #print true_distance, wrong_distances, correct
